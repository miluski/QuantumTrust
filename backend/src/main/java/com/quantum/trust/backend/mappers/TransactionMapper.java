 ...
 * @description Mapper class for converting between Transaction entities and
 *              Transaction DTOs.
 *
 * @class TransactionMapper
 *
 * @method convertToTransactionDto - Converts a Transaction entity to a
 *         TransactionDto.
 * @param {Transaction} transaction - The Transaction entity to convert.
 * @returns {TransactionDto} - The converted TransactionDto.
 *
 * @method convertToTransaction - Converts a TransactionDto to a Transaction
 *         entity.
 * @param {TransactionDto} transactionDto - The TransactionDto to convert.
 * @returns {Transaction} - The converted Transaction entity.
 */
@Component
