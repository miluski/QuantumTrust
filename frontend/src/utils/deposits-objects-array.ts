...
export const depositsObjectArray: Deposit[] = [
  ...
  },
  {
    ...
    percent: 4.5,
    description:
      'Im dłużej oszczędzasz, tym więcej zarabiasz! Nasza lokata progresywna oferuje rosnące oprocentowanie, dzięki czemu Twój kapitał pracuje jeszcze efektywniej.',
  },
];
